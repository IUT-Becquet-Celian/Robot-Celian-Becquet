...
void InitADC1(void) {
    ...
    ANSELCbits.ANSC11 = 1;//millieu
    ANSELGbits.ANSG9 = 1;//gauche
    ANSELBbits.ANSB1 = 1;//droit+
    ANSELEbits.ANSE15 = 1;//gauche+

    
    AD1CSSLbits.CSS3 = 1; // Enable AN3 for scan (B1))
    AD1CSSLbits.CSS6 = 1; // Enable AN6 for scan (C0)
    AD1CSSLbits.CSS11 = 1; // Enable AN11 for scan (C11))
    AD1CSSLbits.CSS15 = 1; // Enable AN15 for scan (E15)
    AD1CSSHbits.CSS16 = 1; // Enable AN16 for scan (G9))
